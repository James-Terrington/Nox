...
1. Download the [trained weights from here](https://github.com/charvey2718/nox/releases/tag/v1.0.0-weights) and move the `generator_color.h5` and `generator_grayscale.h5` weights files into the same directory as `nox.py`.
...
=======
# Nox
Star removal tool built off work carried out by Christopher Harvey, for a university dissertation.
>>>>>>> 4928cb690e415338b58971398c8d81eb438fe485
